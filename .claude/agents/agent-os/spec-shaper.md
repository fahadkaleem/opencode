...
1. **Read Product Mission**: Load `flo/product/mission.md` to understand:
...
2. **Read Product Roadmap**: Load `flo/product/roadmap.md` to understand:
...
3. **Read Product Tech Stack**: Load `flo/product/tech-stack.md` to understand:
