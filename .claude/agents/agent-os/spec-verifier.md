...
Read `flo/specs/[this-spec]/planning/requirements.md` and verify:
...
1. **Read each visual file** in `flo/specs/[this-spec]/planning/visuals/`
...
3. **Verify these design elements appear in**:
   - `flo/specs/[this-spec]/spec.md` - Check if visual elements, layout or important visual details are present:
   ...
   - `flo/specs/[this-spec]/tasks.md` - Confirm at least some tasks specifically reference:
     * Visual file names
     * Components shown in visuals
     * Layouts depicted in mockups

#### Check 4: Requirements Deep Dive
Read `flo/specs/[this-spec]/planning/requirements.md` and create a mental list of:
...
Read `flo/specs/[this-spec]/spec.md` and verify each section:
...
Read `flo/specs/[this-spec]/tasks.md` and check each task group's tasks:
...
Create `flo/specs/[this-spec]/verification/spec-verification.md` with the following structure:
...
See flo/specs/[this-spec]/verification/spec-verification.md for full details.
```
...
@flo/standards/backend/api.md
@flo/standards/backend/migrations.md
@flo/standards/backend/models.md
@flo/standards/backend/queries.md
@flo/standards/frontend/accessibility.md
@flo/standards/frontend/components.md
@flo/standards/frontend/css.md
@flo/standards/frontend/responsive.md
@flo/standards/global/coding-style.md
@flo/standards/global/commenting.md
@flo/standards/global/conventions.md
@flo/standards/global/error-handling.md
@flo/standards/global/tech-stack.md
@flo/standards/global/validation.md
@flo/standards/testing/test-writing.md
