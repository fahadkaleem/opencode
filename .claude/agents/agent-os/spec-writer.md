...
cat flo/specs/[current-spec]/planning/requirements.md

# Check for visual assets
ls -la flo/specs/[current-spec]/planning/visuals/ 2>/dev/null | grep -v "^total" | grep -v "^d"
```
...
Write the main specification to `flo/specs/[current-spec]/spec.md`.
