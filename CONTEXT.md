...
FloMaster lives within OpenCode's monorepo structure:

```
flomaster-opencode/
├── packages/
│   ├── opencode/           ← Core CLI + orchestrator
│   │   ├── src/
│   │   │   ├── orchestrator/   ← FloMaster orchestration engine
│   │   │   ├── session/        ← Session management (used by orchestrator)
│   │   │   ├── agent/          ← Agent definitions (used by orchestrator)
│   │   │   ├── provider/       ← LLM providers
│   │   │   ├── tool/           ← Agent tools
│   │   │   └── cli/cmd/        ← CLI commands including workflow.ts
│   │   └── test/
│   ├── sdk/                ← TypeScript SDK
...
The orchestrator (`packages/opencode/src/orchestrator/`) contains:
