...
import { executeStep } from "../actors/stepActor"
import type {
  ExecuteStepInput,
  ExecuteStepOutput,
  ParsedStep,
...
export const workflowMachine = setup({
  ...
  guards,
  // @ts-expect-error XState v5 assign() type inference doesn't match setup() expectations
  // This is a known limitation - the runtime behavior is correct
  actions,
}).createMachine({
  id: "workflow",
  initial: "idle",
