...
// Import and re-export from registry/types.ts to avoid circular dependency
// These types are defined in registry/types.ts but re-exported here for backward compatibility
import type {
  StepExecutionEvent as _StepExecutionEvent,
  StepEventEmitter as _StepEventEmitter,
  StepExecutorRegistryInterface as _StepExecutorRegistryInterface,
} from "./registry/types"

export type StepExecutionEvent = _StepExecutionEvent
export type StepEventEmitter = _StepEventEmitter
export type StepExecutorRegistryInterface = _StepExecutorRegistryInterface
 ...
 */
import type { StepExecutionStatus } from "../state/types"
...
export type ExecutionOptions = {
  ...
  /** Parent session ID (use existing session instead of creating new workflow session) */
